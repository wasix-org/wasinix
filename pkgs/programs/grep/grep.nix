...
(gnugrep.override {
  ...
  postPatch =
    (lib.optionalString (old.postPatch != null) old.postPatch)
    + lib.optionalString stdenv.hostPlatform.isWasi ''
  ...
  postInstall =
    (lib.optionalString (old.postInstall != null) old.postInstall)
    + ''
