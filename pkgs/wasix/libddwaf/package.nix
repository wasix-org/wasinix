...
exposePackage (
  let
    rapidjson = packages.sameProfile.buildPackages.rapidjson.src;
  in
    packages.sameProfile.stdenv.mkDerivation (finalAttrs: {
      pname = "libddwaf";
      version = "2.0.0";
      ...
      nativeBuildInputs = [packages.sameProfile.buildPackages.cmake];
