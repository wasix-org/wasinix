...
exposePackage (
  let
    rust = import ./lib/rust.nix {final = pkgs;};
  in
    package.overrideAttrs (old: {
      ...
      propagatedBuildInputs =
        ...
        ++ [
          pkgs.rustPlatform.wasixDepCcHook
          pkgs.rustPlatform.wasixLockAmendHook
        ];
      ...
      setupHook = pkgs.writeText "wasix-setuptools-rust-hook.sh" ''
        setuptoolsRustSetup() {
