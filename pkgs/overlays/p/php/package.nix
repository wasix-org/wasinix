...
in {
  ...
  packages = {
    ...
    mkPhp = webcName: spec: int64: history: extensionSelector: let
      ...
      basePhp = final.callPackage "${nixpkgs}/pkgs/development/interpreters/php/generic.nix" {
      ...
      nixpkgsPhpPackages = final.callPackage "${nixpkgs}/pkgs/top-level/php-packages.nix" {
      ...
      '';
    in
      helpers.wasmRename {wasmName = "php";} (helpers.libTweaks {
          ...
          passthru = old:
            builtins.removeAttrs old ["buildEnv" "updateScript"]
            // {
