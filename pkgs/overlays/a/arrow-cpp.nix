...
exposeWasixPackage (
  ...
  in
    extendPackage base {
      ...
      buildInputs = _: [packages.sameProfile.zlib packages.sameProfile.zstd packages.sameProfile.lz4 packages.sameProfile.snappy packages.sameProfile.thrift packages.sameProfile.openssl];
      propagatedBuildInputs = _: [packages.sameProfile.zlib packages.sameProfile.zstd packages.sameProfile.lz4 packages.sameProfile.snappy packages.sameProfile.thrift packages.sameProfile.openssl];
      ...
      cmakeFlags = [
        ...
        "-DBoost_INCLUDE_DIR=${packages.sameProfile.buildPackages.boost.dev}/include"
      ...
      env = old:
        {
          ...
          ARROW_RAPIDJSON_URL = packages.sameProfile.buildPackages.fetchurl {
