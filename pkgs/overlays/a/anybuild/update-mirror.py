...
"""Regenerate the PyPI pin set the hermetic anybuild template tests build against.
    ...
    pkgs/overlays/a/anybuild/update-mirror.py --force
...
left to make. Writes pkgs/overlays/a/anybuild/tests/mirror-lock.json:
...
LOCK = REPO / "pkgs/overlays/a/anybuild/tests/mirror-lock.json"
