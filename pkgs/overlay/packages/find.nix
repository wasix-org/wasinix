# coreutils pinned to the build platform (findutils bakes its paths into scripts
# at build time). fork → ENOSYS; gnulib opendirat renamed off the libc clash.
{
  final,
  prev,
  helpers,
...
helpers.wasmRename {wasmName = "find";} (
  helpers.libTweaks {
    postPatch = ''
